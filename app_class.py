...
class App:
    def __init__(self):
        ...
        self.coins = []  # no class
        self.bonus = []
        self.enemies = []  # List of Enemy´s objects
        self.e_pos = []
        self.p_pos = None
        self.load()
        self.player = Player(self, vec(self.p_pos))  # Player class object
        self.make_enemies()
...
############################ HELPER FUNCTIONS ##################################
    ...
    def make_enemies(self):
        for idx, pos in enumerate(self.e_pos):
            self.enemies.append(Enemy(self, vec(pos), idx))  # Enemy object
...
########################### PLAYING FUNCTIONS ##################################
    ...
    def draw_bonus(self):
        for bonus in self.bonus:
            pygame.draw.circle(self.screen, (200, 123, 200),
                               (int(bonus.x*self.cell_width)+self.cell_width//2+TOP_BOTTOM_BUFFER//2,
                                int(bonus.y*self.cell_height)+self.cell_height//2+TOP_BOTTOM_BUFFER//2), 7)
